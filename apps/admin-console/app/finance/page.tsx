        ...
        <Panel title="最近结算订单" subtitle="查看支付、确认和结算进度。">
          <form className="toolbar-form" method="get">
            <div className="toolbar-form__field">
              <label className="toolbar-form__label" htmlFor="finance-q">
                搜索
              </label>
              <input
            ...
            <div className="toolbar-form__field">
              <label className="toolbar-form__label" htmlFor="finance-status">
                状态
              </label>
              <select className="toolbar-form__select" defaultValue={filters.status ?? ""} id="finance-status" name="status">
            ...
            <div className="toolbar-form__actions">
              ...
              <a className="toolbar-form__link" href="/finance">
                重置
              </a>
            </div>
          </form>
          ...
          <Panel title="财务概览" subtitle="封闭测试阶段的精简财务视角。">
            <div className="meta-list">
              <div className="meta-row">
                <span className="meta-row__label">订单总数</span>
                <strong>{finance.metrics.totalOrders}</strong>
              </div>
              <div className="meta-row">
                <span className="meta-row__label">已确认订单</span>
                <strong>{finance.metrics.confirmedOrders}</strong>
              </div>
              <div className="meta-row">
                <span className="meta-row__label">已使用 Token</span>
                <strong>{formatNumber(finance.metrics.tokenUsed)}</strong>
              </div>
              <div className="meta-row">
                <span className="meta-row__label">即将到期 API 池</span>
                <strong>{finance.metrics.apiPoolExpiring}</strong>
              </div>
            </div>
          </Panel>
