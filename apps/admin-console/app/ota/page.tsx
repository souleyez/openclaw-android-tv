        ...
        <div className="stack">
          ...
          <Panel title="创建发布" subtitle="登记新版本并放入指定灰度环。">
            <form action={createOtaReleaseAction} className="stack-form">
              ...
              <div className="toolbar-form__field"><label className="toolbar-form__label" htmlFor="ota-target-scope">目标范围</label><input className="toolbar-form__input" defaultValue={selectedTemplate?.targetScope ?? ""} id="ota-target-scope" name="targetScope" placeholder="radio-app / internal / CN" /></div>
