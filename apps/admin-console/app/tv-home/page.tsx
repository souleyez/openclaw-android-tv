  ...
  return (
    <Shell eyebrow="TV Home" title="首页投放配置">
      <div className="grid-2">
          ...
          <form action={saveTvHomeConfigAction} className="stack-form">
            ...
            <label>
              ...
              <input
                ...
                placeholder="https://cdn.example.com/tv-home/us-hero.jpg"
              />
            </label>
            ...
            <label>
              ...
              <textarea
                ...
                placeholder="youtube, netflix, prime_video, disney_plus, plex"
              />
            </label>
        ...
        <Panel
          title="支持目录"
          subtitle="`full` 表示当前控制链路较完整；`basic` 仅保证打开应用和基础遥控。"
        >
          <SimpleTable
      ...
      <Panel
        title="已保存配置"
        subtitle="客户端按 `国家+区域` 精确命中，找不到时回退到国家默认，再回退到 GLOBAL。"
      >
        <SimpleTable
