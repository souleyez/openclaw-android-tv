...
function Test-HandoffExport {
    ...
    $checks = @(
        ...
        [pscustomobject]@{ ok = $manifest.evidence.targetDeviceAdmin.copied -eq $true; detail = "targetDeviceAdminEvidenceCopied=$($manifest.evidence.targetDeviceAdmin.copied)" },
