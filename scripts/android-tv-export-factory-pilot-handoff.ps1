...
$paymentRenewalEvidenceCopied = $false
...
$manifest = [pscustomobject]@{
    ...
    evidence = [pscustomobject]@{
        ...
        paymentRenewal = [pscustomobject]@{
            copied = $paymentRenewalEvidenceCopied
    ...
    localVerificationCommands = @(
        ...
        'powershell -NoProfile -ExecutionPolicy Bypass -File scripts\android-tv-test-target-device-admin-evidence.ps1',
        ...
        'powershell -NoProfile -ExecutionPolicy Bypass -File scripts\android-tv-test-next-apk-candidate-gate.ps1',
        'powershell -NoProfile -ExecutionPolicy Bypass -File scripts\android-tv-test-handoff-archive-next-candidate-evidence.ps1',
...
9. Logs package path for install, Home, casting, OTA, crash/ANR, and support diagnostics.
